...
export default function Details() {
    return (
        <div className="bg-foreground rounded-lg h-full relative z-[1]">
            ...
            <div className="absolute inset-0 bg-gradient-to-b from-black/10 to-foreground h-[400px]" />
            <div className="flex justify-between sticky top-0 inset-x-0 p-3 rounded-xl z-[1]">
