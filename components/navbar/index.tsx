    ...
    <div className="flex items-center justify-between text-dimmed">
      ...
      <div className="flex items-center gap-1.5 text-white">
        <div className="rounded-full text-lg font-bold border-2">
          ...
          <span className="font-semibold text-xs">Instalar App</span>
        </div>
        ...
        <Image 
          ...
          src="https://imtexpublicidad.mx/wp-content/uploads/2021/04/Como-ser-xitoso-como-Homero-Simpson.jpeg"
        />
      </div>
    </div>
  )
